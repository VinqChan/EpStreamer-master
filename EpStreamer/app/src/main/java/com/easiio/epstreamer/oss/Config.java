...
public class Config {
    ...
    public static final String STS_SERVER_URL = "https://pbx.easiio.cn/sts-server/sts.php";//STS 地址

    public static final String BUCKET_NAME = "easiio-pitch";
    public static final String OSS_ACCESS_KEY_ID = "LTAI9gH0wQ073O4m";
    public static final String OSS_ACCESS_KEY_SECRET = "hzxTWxR0TIxrpxzAD3WWXDCtCwyU4o";
