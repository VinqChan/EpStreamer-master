...
import com.easiio.epstreamer.util.CommonUtil;
import com.easiio.epstreamer.util.DiskUtils;
import com.easiio.epstreamer.util.PermissionManager;
import com.easiio.epstreamer.util.PreferencesUtil;
...
public class PreViewFileActivity extends AppCompatActivity implements TbsReaderView.ReaderCallback, PermissionManager.OnPermissionListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pdfUrl = Environment.getExternalStorageDirectory().getPath() + File.separator + "epstrreamer"+ File.separator +"Ethan-2019-10-31-Weekly Report.pptx";
    ...
    private void downloadOrOpenFile() {
        if (PermissionManager.getInstance().checkPermissions(this, PermissionManager.PERMISSION_READ_WRITE)) {
            openPdfFile(new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "epstrreamer"+ File.separator +"Ethan-2019-10-31-Weekly Report.pptx"));
...
//            }
    ...
    private void openPdfFile(File file) {
        Log.e(TAG, "openPdfFile: "+file.getPath() );
        if (null != file) {
            displayFile(file);
        }
    }
